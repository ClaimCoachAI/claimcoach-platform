...
ALTER TABLE claims
    ADD COLUMN IF NOT EXISTS legal_partner_name    VARCHAR(255),
    ADD COLUMN IF NOT EXISTS legal_partner_email   VARCHAR(255),
    ADD COLUMN IF NOT EXISTS owner_email           VARCHAR(255),
    ADD COLUMN IF NOT EXISTS legal_escalation_status VARCHAR(50)
