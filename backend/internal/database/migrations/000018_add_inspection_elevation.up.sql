-- 000018_add_inspection_elevation.up.sql
...
CREATE TABLE inspection_elevation (
    ...
    siding_type       TEXT    CHECK (siding_type IN ('vinyl','wood','fiber_cement','brick','stucco','other')),  -- nullable; app enforces when has_damage = true
