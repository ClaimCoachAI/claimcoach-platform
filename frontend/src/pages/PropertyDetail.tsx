        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="btn-secondary inline-flex items-center px-4 py-3 rounded-xl text-sm font-medium"
            >
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-3 rounded-xl text-sm font-medium text-red-600 border border-red-200 bg-red-50 hover:bg-red-100 transition-colors"
            >
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="animate-fade-in space-y-4" role="tabpanel" id="panel-policy" aria-labelledby="tab-policy">
            ...
            <div className="glass-card rounded-2xl p-5 border border-red-100">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-navy">Delete this property</p>
                  <p className="text-xs text-slate mt-0.5">Permanently removes the property and all associated claims</p>
                </div>
                <button
                  onClick={() => setShowDeletePropertyConfirm(true)}
                  className="inline-flex items-center px-4 py-2 rounded-xl text-sm font-semibold text-red-600 border border-red-200 bg-red-50 hover:bg-red-100 transition-colors"
                >
                  Delete Property
                </button>
              </div>
      ...
      {showDeletePropertyConfirm && (
        <div className="fixed inset-0 z-50 overflow-y-auto animate-fade-in">
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            <div
              className="fixed inset-0 transition-opacity bg-navy/20 backdrop-blur-sm"
              onClick={() => setShowDeletePropertyConfirm(false)}
            />
            <div className="inline-block w-full max-w-md my-8 overflow-hidden text-left align-middle transition-all transform glass-card-strong shadow-2xl rounded-3xl animate-scale-in">
              <div className="px-8 py-6">
                <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-2xl bg-red-50">
                ...
                <p className="text-sm text-slate text-center mb-6">
                  This will permanently delete <strong>{property.nickname}</strong> and all its claims and policy. This cannot be undone.
                </p>
                <div className="flex gap-3">
                  <button
                    type="button"
                    ...
                    className="flex-1 btn-secondary px-6 py-3 rounded-xl text-sm font-medium disabled:opacity-50"
                  >
                    Cancel
                  </button>
                  <button
